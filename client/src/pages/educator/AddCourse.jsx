    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div>
                ...
                <div className="p-4">
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className="flex justify-between items-center mb-2">
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} target="_blank" className="text-emerald-600 hover:underline">Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid'}</span>
          ...
          <div className="flex justify-center items-center bg-emerald-300 text-emerald-800 p-2 rounded-lg cursor-pointer" onClick={() => handleChapter('add')}>
            + Add Chapter
          </div>
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <button type='button' className="w-full bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded" onClick={addLecture}>Add</button>
