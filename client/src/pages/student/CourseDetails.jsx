    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className='text-sm'>Course by <span className='text-emerald-600 underline'>{courseData.educator.name}</span></p>
                        ...
                        <li key={i} className="flex items-start gap-2 py-1">
                          ...
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                            ...
                            <div className='flex gap-2'>
                              ...
                              })} className='text-emerald-500 cursor-pointer'>Preview</p>}
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <button onClick={enrollCourse} className={`md:mt-6 mt-4 w-full py-3 rounded font-medium text-white ${isAlreadyEnrolled ? 'bg-gray-400 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-700'}`}>
  {isAlreadyEnrolled ? "Already Enrolled" : "Enroll Now"}
</button> {/* updated to emerald with hover + disabled state */}
