                    ...
                    <li key={i} className="flex items-start gap-2 py-1">
                      ...
                      <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                        ...
                        <div className='flex gap-2'>
                          {lecture.lectureUrl && <p onClick={() => setPlayerData({ ...lecture, chapter: index + 1, lecture: i + 1 })} className='text-emerald-500 cursor-pointer'>Watch</p>}
            ...
            ? (
              <div>
                ...
                <div className='flex justify-between items-center mt-1'>
                  ...
                  <button onClick={() => markLectureAsCompleted(playerData.lectureId)} className='text-emerald-600'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId) ? 'Completed' : 'Mark Complete'}</button>
                </div>
              </div>
            )
