        ...
        <>
            ...
            <div className='md:px-36 px-8 pt-10'>
                ...
                <table className="md:table-auto table-fixed w-full overflow-hidden border mt-10">
                    <thead className="text-emerald-900 border-b border-gray-500/20 text-sm text-left max-sm:hidden">
                        <tr>
                        ...
                        {enrolledCourses.map((course, index) => (
                            <tr key={index} className="border-b border-gray-500/20">
                                ...
                                <td className="px-4 py-3 max-sm:text-right">
                                    <button onClick={() => navigate('/player/' + course._id)} className='px-3 sm:px-5 py-1.5 sm:py-2 bg-emerald-600 max-sm:text-xs text-white'>
